...
android {
    namespace = "com.expstudio.localai"
    compileSdk = 34
    ...
    // The native llama.cpp sources are expected under app/src/main/cpp.
    // The CMakeLists is committed; the actual llama.cpp checkout is fetched
    // by the setup script (see README) so we don't vendor a huge tree.
    externalNativeBuild {
        cmake {
...
dependencies {
    ...
    // Material Components — provides the XML app theme (Theme.Material3.*)
